...
import edu.nitin.testng.issue112.reflect.DataProviderMethodMatcher;
import edu.nitin.testng.issue112.reflect.MethodMatcher;
import edu.nitin.testng.issue112.reflect.MethodMatcherException;
...
public class Main {
  public static void main(final String[] arg)
    ...
    for (final Object[] input : data) {
      final MethodMatcher methodMatcher = new DataProviderMethodMatcher(method, input, null, null);
      if (methodMatcher.conforms()) {
        method.invoke(new Main(), methodMatcher.getConformingArguments());
      }
    }
  }
